...
export function GardenPlot({ student, summary, pulse, saving = false, onSelect }: GardenPlotProps) {
  ...
  return (
    <div className="group relative flex flex-col items-center">
      ...
      <div className="pointer-events-none absolute bottom-full left-1/2 z-20 w-max -translate-x-1/2 pb-1 opacity-0 transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100">
